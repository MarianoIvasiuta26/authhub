        ...
        <form method="POST" action="{{ route('register') }}" class="w-full max-w-lg mx-auto">
            ...
            <div class="flex items-center space-x-4">
                <div class="flex items-center space-x-2">
                    ...
                    <div class="flex items-center space-x-2">
                        <x-input id="tipo_usuario_nutri" type="radio" class="form-radio" name="tipo_usuario" value="1" required disabled />
                        <x-label for="tipo_usuario_nutri" value="{{ __('Nutricionista') }}" />
                    </div>
                    <div class="flex items-center space-x-2">
                        <x-input id="tipo_usuario_paciente" type="radio" class="form-radio" name="tipo_usuario" value="2" required checked />
